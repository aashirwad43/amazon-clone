        ...
        itemsHTML += `
            <div class="cart-item flex items-center pb-4 border-b border-gray-100">
                ...
                <div class="cart-item-counter w-48 flex items-center">
                    <div data-id="${item.id}" class="cart-item-decrease cursor-pointer text-gray-400 bg-gray-100 h-6 w-6 rounded flex justify-center items-center hover:bg-gray-200 mr-2">
                        <i class="fas fa-chevron-left fa-xs"></i>
                    </div>
                    <h4 class="text-gray-400">x${item.quantity}</h4>
                    <div data-id="${item.id}" class="cart-item-increase cursor-pointer text-gray-400 bg-gray-100 h-6 w-6 rounded flex justify-center items-center hover:bg-gray-200 ml-2">
